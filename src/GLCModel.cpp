...
std::vector<GLCTextureStruct> GLCModel::loadMaterialTextures(aiMaterial *mat, aiTextureType type, std::string typeName)
{
    std::vector<GLCTextureStruct> textures;
...
unsigned int GLCModel::TextureFromFile(const char *path, const std::string &directory)
{
